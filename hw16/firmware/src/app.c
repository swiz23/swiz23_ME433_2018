...
// set PWM pins for the two motors
    RPA0Rbits.RPA0R = 0b0101; // A0 to OC1
    RPB13Rbits.RPB13R = 0b0101; // B13 to OC4
    
// Make Timer2 set a PWM frequency of 20kHz for OC1 and OC4
...
// Set encoder pins for the two motors for T5CK and T3CK
...
// Set up Timer 4 for motor control
